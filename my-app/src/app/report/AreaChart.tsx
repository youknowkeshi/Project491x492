...
async function graphareachecklist(
  ...
  return (
    <div>
      <Card>
        <CardHeader>
          <CardTitle>
            จำนวนผู้รับบริการแต่ละชนิดของสุขภาพจิต เปรียบเทียบ
          </CardTitle>
          <CardDescription>
          ...
          >
            <defs>
              <linearGradient id="colorPast" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor={chartConfig.checklist_count_past.color}
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
              ...
              <linearGradient id="colorCurrnet" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor={chartConfig.checklist_count_current.color}
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
            ...
            <Area
              type="monotone"
              dataKey="checklist_count_past"
              stroke={chartConfig.checklist_count_past.color}
              fillOpacity={1}
              fill="url(#colorPast)"
            />
            <Area
              type="monotone"
              dataKey="checklist_count_current"
              stroke={chartConfig.checklist_count_current.color}
              fillOpacity={1}
              fill="url(#colorCurrnet)"
            />
          </AreaChart>
        </CardContent>
      </Card>
