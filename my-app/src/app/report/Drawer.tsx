                ...
                <Sidebar.Items>
                  <Sidebar.ItemGroup>
                    <Sidebar.Item href="/" icon={HiChartPie}>
                      รูปแบบกราฟแสดงจำนวน<br/>ผู้รับบริการแต่ละสาขา
                    </Sidebar.Item>
                    <Sidebar.Item href="/e-commerce/products" icon={PiStudent}>
                      รูปแบบกราฟแสดงจำนวน<br/>ผู้รับบริการแต่ละชั้นปี
                    </Sidebar.Item>
                    <Sidebar.Item href="/users/list" icon={MdOutlineChecklist}>
                      รูปแบบกราฟแสดง<br/>จำนวนผู้รับบริการแต่ละ<br/>ชนิดของสุขภาพจิต
                    </Sidebar.Item>
                  </Sidebar.ItemGroup>
                  <Sidebar.ItemGroup>
