...
const Page: React.FC<Props> = () => {
  ...
  async function countevaluationform(topic: string) {
    const apiUrl = "http://10.10.12.95:3001/api/user/clickevaluation";
    try {
      ...
      <div className="flex justify-start mt-10 mx-10">
        ...
        >
          <div >
            ...
            “จิตใจ” ใครว่าไม่สำคัญ ในห้วงเวลาที่จิตใจของเราเต็มไปด้วยความทุกข์ ความไม่สบาย อาจทำให้การใช้ชีวิตไม่สามารถเดินทางไปสู่ความสำเร็จที่เรามุ่งหวัง 
            เราขอเป็นส่วนหนึ่งในการช่วยทุกคนค้นหาเหตุของความไม่สบายใจ 
            และ ร่วมกับท่านในการดูแลจิตใจของตนเองให้มีความสุข เพราะสุขภาพจิตที่ดี ทำให้เรามีพลังใจที่จะเดินทางสู่ความสำเร็จของชีวิต
            </p>
          </div>
        </Card>
        {/* Vertical divider */}
