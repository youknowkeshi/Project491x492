    ...
    <div className="flex flex-col justify-center p-5 space-y-4">
      ...
      <div className="shadow-lg rounded-lg bg-gray-50 p-5 overflow-hidden">
        <button
          ...
          className="text-white bg-blue-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center"
          type="button"
        >
          Dropdown checkbox{' '}
          <svg
