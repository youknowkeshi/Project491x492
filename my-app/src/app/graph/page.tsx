                          ...
                          <div className="w-1/3 pr-2">
                            ...
                            <div className="p-4 max-h-60 overflow-y-auto flex flex-col gap-4" id="checkbox">
                              <div className="flex items-center gap-2">
                                ...
                                <Label htmlFor="Willpower_test_score" className="flex">คะแนนแบบวัดพลังใจ</Label>
                              </div>
                              <div className='flex items-center gap-2'>
                          ...
                          <div className="w-1/3 pr-2">
                            ...
                            <div className="p-4 max-h-60 overflow-y-auto flex flex-col gap-4" id="checkbox">
                              ...
                              <div className='flex items-center gap-2'>
                                ...
                                <Label htmlFor='Mining'>วิศวกรรมเหมืองแร่</Label>
                              </div>
                              <div className='flex items-center gap-2'>
                                <Checkbox id='Ai' checked={checkedItems.Ai} onChange={handleCheckboxChange} />
                                <Label htmlFor='Ai'>วิศวกรรมปัญญาประดิษฐ์</Label>
                              </div>
                              <div className='flex items-center gap-2'>
