...
export default function Page({ }: Props) {
    ...
    const handleUpload = async () => {
        ...
        const apiUrl = "https://entaneermindbackend.onrender.com/api/img/upload"; // Update with your actual API endpoint
    ...
    async function deletearticle(id: string) {
        const apiUrl = `https://entaneermindbackend.onrender.com/api/img/delimgtest`;
        try {
