          ...
          <div className="divide-y dark:divide-gray-300">
            ...
            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
              ...
              <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                ...
                <span className="mt-2 dark:text-gray-700">
                หลังจากพูดคุยเบื้องต้นกับนักจิตวิทยา ผู้ใช้จะได้รับรหัสสำหรับเข้ารับบริการครั้งแรก เมื่อผู้ใช้ทำการ ล็อกอิน เข้าสู่ระบบแล้ว ให้ไปที่หน้า
                 ลงทะเบียน จากนั้นกรอกข้อมูลส่วนตัวที่จำเป็นให้ครบถ้วน และนำ รหัสเข้ารับบริการครั้งแรก ที่ได้รับมากรอกในช่องสำหรับการลงทะเบียน
                </span>
              </div>
            </div>
            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
